...
class Program
{
    public static function main(array $args = [])
    {
        ...
        if ($result)
        {
            ...
            self::copyFile( __DIR__.'/resources/webroot/css/materialize.min.css', $rootPath."/webroot/css/materialize.min.css");
            self::copyFile( __DIR__.'/resources/webroot/css/style.css', $rootPath."/webroot/css/style.css");
            self::copyFile( __DIR__.'/resources/webroot/js/materialize.min.js', $rootPath."/webroot/js/materialize.min.js");
